=== Orig User Avatar | User Profile Picture ===
...
> Heads-up: This is a fork of the original WP User Avatar plugin, before it became "ProfilePress". This plugin is based on wp-user-avatar version 2.2.16
